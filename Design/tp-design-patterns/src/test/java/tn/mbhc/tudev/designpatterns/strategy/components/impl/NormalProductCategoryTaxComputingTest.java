...
public class NormalProductCategoryTaxComputingTest {

	private IProductTaxesIncludedPriceComputingStrategy strategy;

	@Before
	public void before() {
		strategy = new NormalProductCategoryTaxComputingImpl();
	}
	...
	public void testTaxedPriceComputing() {
		...
		BigDecimal expectedTaxedPrice = new BigDecimal(11.90).setScale(2, RoundingMode.HALF_EVEN);
	...
	public void shouldThrowExceptionForNonNormalProductCategory() {
		// Arrange
